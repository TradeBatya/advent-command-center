...
const RecruitmentSection = () => {
  const benefits = [
    'Sovereign nullsec territory',
    '100% SRP (Ship Replacement)',
    'Experienced FCs & daily fleets',
    'Advanced industrial infrastructure',
    'Capital construction facilities',
    'Active Discord community',
    'Competitive buy-back programs',
    'PvP mentorship & training',
  ];

  const requirements = [
    '10M+ skill points recommended',
    'Omega clone status',
    'Discord + working microphone',
    'ESI verification (security)',
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="font-exo font-black text-4xl sm:text-5xl lg:text-6xl tracking-wider text-foreground mb-6 text-glow-red">
            BECOME AN <span className="text-primary">ADVENT PILOT</span>
          </h2>
          <p className="font-inter text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed">
            We seek capsuleers ready to dominate nullsec. Whether you're a fleet commander, industrialist, or hunter, ADVENT offers the platform for your legend.
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="font-inter text-sm text-muted-foreground mt-4">Response time: &lt; 24 hours</p>
        </div>
      </div>
    </section>
  );
